...
`;var oe=e=>r.createElement(re,Object.assign({},e)),ae=n(5733),le=n.n(ae),ie=function(e,t,n,r){return new(n||(n=Promise))((function(o,a){function l(e){try{c(r.next(e))}catch(e){a(e)}}function i(e){try{c(r.throw(e))}catch(e){a(e)}}function c(e){var t;e.done?o(e.value):(t=e.value,t instanceof n?t:new n((function(e){e(t)}))).then(l,i)}c((r=r.apply(e,t||[])).next())}))},ce=()=>{const[e,t]=r.useState(""),[n,o]=r.useState(!1),{$:a}=z(),l=n=>ie(void 0,void 0,void 0,(function*(){o(!0);const r=new(le());r.file("Hello.txt","\n            👋 Thanks for using the 🎯 image tracker 🎯!\n\n            about us : https://image-tracker.taplink.ws/\n        ");const a=r.folder("images");n.forEach((({blob:n,alt:r,extension:o},l)=>{t(o),a.file(`${l+1+"-"+r}.${e||o}`,n)}));const l=yield r.generateAsync({type:"blob"});return{blob:l,link:URL.createObjectURL(l)}}));return{Create:l,setExtesion:t,Extension:e,Download(e){return ie(this,void 0,void 0,(function*(){const t=yield l(e),n=document.createElement("a");n.href=t.link,n.download="Image-Tracker-Zip-Images",n.target="__blank",n.click(),n.remove(),URL.revokeObjectURL(t.link),o(!1)}))},isFallback:n}},se=n(3935);const me=u.ZP.div`
    width: 100%;
    height: 120vh;
    position: fixed;
    z-index: 9999;
