...
const Card = ({ alt, src, id }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_index_styles__WEBPACK_IMPORTED_MODULE_2__.Container, null,
        ...
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(_Tools__WEBPACK_IMPORTED_MODULE_3__["default"], { href: src, download: alt, id: id })));
};
...
/* harmony import */ var _ProfileModal__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./ProfileModal */ "./src/Components/Nav/Footer/ProfileModal/index.tsx");
...
/* harmony import */ var _Hooks_useWindow__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../Hooks/useWindow */ "./src/Hooks/useWindow/index.tsx");
...
const Footer = () => {
    const { right, left } = (0,_Contexts_LiveStorageContext_useLiveStorageCTX__WEBPACK_IMPORTED_MODULE_8__["default"])();
    ...
    const { WindowConfig } = (0,_Hooks_useWindow__WEBPACK_IMPORTED_MODULE_9__["default"])();
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_index_styles__WEBPACK_IMPORTED_MODULE_2__.Container, null,
        isOpen.tools &&
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(_ToolModal__WEBPACK_IMPORTED_MODULE_5__["default"], null),
        isOpen.profile &&
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(_ProfileModal__WEBPACK_IMPORTED_MODULE_7__["default"], null),
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(_Layout_Flex__WEBPACK_IMPORTED_MODULE_6__["default"], { justContent: 'center' },
            ...
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(_Button__WEBPACK_IMPORTED_MODULE_3__["default"], { title: 'Shop', onClick: () => {
...
const LiveStorageProvider = ({ children }) => {
    ...
    const [CurrentFilters, setCurrentFilters] = react__WEBPACK_IMPORTED_MODULE_1__.useState([]);
...
const useHowLogo = () => {
    ...
    const verifyLogo = () => {
        ...
        if ((member === null || member === void 0 ? void 0 : member.signature) === 'orichalcum') {
...
/* harmony import */ var _Contexts_LiveStorageContext_useLiveStorageCTX__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../Contexts/LiveStorageContext/useLiveStorageCTX */ "./src/Contexts/LiveStorageContext/useLiveStorageCTX/index.tsx");
/* harmony import */ var _Hooks_useHowLogo__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../Hooks/useHowLogo */ "./src/Hooks/useHowLogo/index.tsx");
...
const Home = () => {
    ...
    const { isAuth } = (0,_Contexts_AuthContext_useAuthCTX__WEBPACK_IMPORTED_MODULE_7__["default"])();
    const HowLogo = (0,_Hooks_useHowLogo__WEBPACK_IMPORTED_MODULE_9__["default"])();
    const Goto = (0,react_router_dom__WEBPACK_IMPORTED_MODULE_10__.useNavigate)();
    react__WEBPACK_IMPORTED_MODULE_0__.useEffect(() => {
        if (!isAuth) {
            Goto('/');
        }
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendors-node_modules_react-dom_client_js-node_modules_styled-components_dist_styled-component-830dfd","vendors-node_modules_axios_index_js-node_modules_dexie-react-hooks_dist_dexie-react-hooks_js--086f42"], function() { return __webpack_require__("./src/Extension/Popup/index.tsx"); })
